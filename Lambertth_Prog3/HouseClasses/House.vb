...
Public MustInherit Class House
   ...
   ' Sub used to raise HouseListUpdated event
   Protected Sub houseEvent()
      RaiseEvent HouseListUpdated()
   End Sub

   ' Raised when a house is created, removed, 
   ' or modified (price changed or not).
   ...
   ' This sub is used to dispose of the given house
   Public Sub remove(h As House)
